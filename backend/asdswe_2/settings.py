"""
Django settings for asdswe_2 project.
...
WSGI_APPLICATION = 'asdswe_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asdswe_2 API",
    "DESCRIPTION": "API documentation for asdswe_2 App",
    "VERSION": "v1",
}
